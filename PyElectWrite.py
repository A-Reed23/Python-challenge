...
#create text output
with open('Py1Elect.txt', 'w') as textfile:
    # Write to the file

#Heading
    textfile.write("                     Election Results\n ------------------------------------------------------- \n \n")
#prints out total ballots
    textfile.write("Total ballots cast: " +str(VotTot))
    textfile.write("\n----------------------------------------------------------\n                 Results\n")
...
#print statment with percentage rounded. then turned into a string, as python likes
        textfile.write(Cand + ": " +str(round(float(perc),2))+ "% (" +tot + ")\n")
#Printout formating
    textfile.write('\n------------------------------------------------------------\n')
    
    textfile.write("Winner: " + str(list(converted_dict.keys())[0]))
